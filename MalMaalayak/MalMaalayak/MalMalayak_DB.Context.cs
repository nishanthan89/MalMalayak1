...
namespace MalMaalayak
{
    ...
    public partial class MalMalayakDbEntities2 : DbContext
    {
        public MalMalayakDbEntities2()
            : base("name=MalMalayakDbEntities2")
        {
        }
        ...
        public virtual DbSet<Lagna> Lagnas { get; set; }
